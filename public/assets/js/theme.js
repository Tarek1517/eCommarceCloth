    ...
    class Uomo {
        ...
        initRangeSlider() {
            ...
            document.querySelectorAll(selectors.elementClass).forEach(($se) => {
                ...
                if ($se) {
                    // Initialize the slider with custom settings
                    ...
                    priceRange.on("slideStop", (value) => {
                        ...
                        // Update hidden inputs for min and max values
                        document.querySelector(selectors.minInput).value =
                            value[0];
                        document.querySelector(selectors.maxInput).value =
                            value[1];

                        // Submit the form automatically after sliding stops
                        setTimeout(() => {
                            document.querySelector("#frmFilter").submit();
                        }, 2000); // Optional delay before submitting
                    });
                }
            });
        }
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (registerButton) {
            ...
            registerButton.addEventListener("click", function (e) {
                ...
                if (targetElement) {
                    targetElement.click(); // Simulate click on the target element
                }
            });
        }
    });
