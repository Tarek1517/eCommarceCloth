    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                ...
                <form class="form-new-product form-style-1" action="{{ route('update.category', $editCategory->id) }}"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Brand name" name="name" tabindex="0"
                            id="name" value="{{ $editCategory->name }}" aria-required="true" required="">
                    </fieldset>
                    <fieldset class="name">
                        <div class="body-title">Category Slug <span class="tf-color-1">*</span></div>
                        <input class="flex-grow" type="text" placeholder="Category Slug" name="slug" tabindex="0"
                            value="{{ $editCategory->slug }}" aria-required="true" required="" id="slug">
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            <div class="item" id="imgpreview" style=" border-radius: 10px;">
                                <img src="{{ asset('/storage/img/') }}/{{ $editCategory->image }}" class="effect8" alt="">
                            </div>
