    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <div class="text-tiny">Update Size</div>
                </li>
            </ul>
        </div>
        ...
        <div class="wg-box">
            ...
            <form class="form-new-product form-style-1" action="{{ route('update.size', $editSize->id) }}" method="post"
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="size name" name="name" id="name"
                        tabindex="0" value="{{ $editSize->name }}" aria-required="true" required="">
                </fieldset>
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Size Slug" name="slug" id="slug"
                        tabindex="0" value="{{ $editSize->slug }}" aria-required="true" required="">
                </fieldset>
                <fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        <div class="item" id="imgpreview" style=" border-radius: 10px;">
                            <img src="{{ asset('/storage/img/') }}/{{ $editSize->image }}" class="effect8" alt="">
                        </div>
