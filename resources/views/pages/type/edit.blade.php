...
<div class="main-content-inner">
    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            ...
            <form class="form-new-product form-style-1" action="{{ route('update.type', $editType->id) }}" method="POST"
                ...
                <fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        <div class="item" id="imgpreview" style=" border-radius: 10px;">
                            <img src="{{ asset('/storage/img/') }}/{{ $editType->image }}" class="effect8" alt="">
                        </div>
