    ...
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                ...
                <form class="form-new-product form-style-1" action="{{ route('update.shop.slides', $editShopSlides->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <fieldset class="name">
                        <div class="body-title">Title <span class="tf-color-1">*</span></div>
                        <input class="flex-grow" type="text" placeholder="Title" name="title" tabindex="0"
                            value="{{ $editShopSlides->title }}" aria-required="true" required="">
                    </fieldset>
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Bold Title" name="btitle" tabindex="0"
                            value="{{ $editShopSlides->btitle }}" aria-required="true" required="">
                    </fieldset>
                    ...
                    <fieldset class="description">
                        ...
                        <textarea class="mb-10" name="description" placeholder="Description" tabindex="0" aria-required="true"
                            required="">{{ $editShopSlides->description }}</textarea>
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            <div class="item" id="imgpreview" style=" border-radius: 10px;">
                                <img src="{{ asset('/storage/img/') }}/{{ $editShopSlides->image }}" class="effect8" alt="">
                            </div>
                    ...
                    <fieldset class="category">
                        ...
                        <div class="select flex-grow">
                            <select class="" name="status">
                                <option value="active" {{ $editShopSlides->status == 'active' ? 'selected' : '' }}>active</option>
                                <option value="inactive" {{ $editShopSlides->status == 'inactive' ? 'selected' : '' }}>inactive</option>
                            </select>
                        </div>
                    </fieldset>
