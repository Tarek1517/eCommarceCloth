        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <a href="#">
                            <div class="text-tiny">Affiliate</div>
                        </a>
                    </li>
                    <li>
                        <i class="icon-chevron-right"></i>
                    ...
                    <li>
                        <div class="text-tiny">Edit Affiliate Data</div>
                    </li>
                </ul>
            </div>
            ...
            <div class="wg-box">
                ...
                <form class="form-new-product gap-5" action="{{ route('store.affiliate', $editAffiliate->id) }}" method="POST"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Title" name="name" tabindex="0"
                            value="{{ $editAffiliate->name }}" aria-required="true" required="">
                    </fieldset>
...
<script>
    var description = {!! json_encode($editAffiliate->description) !!}; // Passing PHP data to a JS variable
</script>
